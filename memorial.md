...
| :--- | :--- |
| Peso Próprio | 3.25 |
| Carga Total (Calculada $p_d$) | **7.25** |
...
* **Armadura Principal (X):** Ø6.3 c/15 (Teórico: 2.10 cm²/m)
* **Armadura Secundária (Y):** Ø5.0 c/10 (Teórico: 1.95 cm²/m)
* **Cisalhamento:** Ratio 0.39 - Status: OK

### 2.5 Verificações de Serviço (ELS)
* **Flecha Total:** 14.30 mm (Limite $L/250$: 16.00 mm)
* **Contraflecha Sugerida:** 7.0 mm
* **Abertura de Fissuras ($w_k$):** 0.175 mm - Status: OK
